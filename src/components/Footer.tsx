...
const columns = [
  ...
  },
  {
    title: "Trust & Safety",
    links: [
      { href: "/trust", label: "Trust & Safeguarding Framework" },
      { href: "/trust#vetting", label: "Tutor Vetting & DBS Policy" },
      { href: "/trust#data", label: "Data & Privacy (UK GDPR / Children's Code)" },
      { href: "/trust#report", label: "Report a Concern" },
      { href: "/trust#accessibility", label: "Accessibility Statement" },
    ],
  },
  {
    title: "Company",
