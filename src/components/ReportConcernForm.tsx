  ...
  if (submitted) {
    return (
      <Card tint="teal" className="text-center">
        ...
        <p className="font-display font-bold text-lg mt-3 mb-1">Thank you for reporting this</p>
        <p className="text-charcoal-teal/80 text-sm">
  ...
  return (
    <Card>
      <p className="text-sm text-charcoal-teal/70 mb-4">
        This goes directly to our Designated Safeguarding Lead. If a child is in immediate
