...
export default function TutorMessagesPage() {
  ...
  const send = () => {
    ...
    setThread((t) => [
      ...t,
      { id: `m${t.length + 1}`, sender: "tutor", senderName: "Ms. Reece", content: draft, time: "now" },
    ]);
    setDraft("");
  };
  ...
  return (
    <PageShell>
      <main className="max-w-2xl mx-auto px-6 py-10">
        <h1 className="font-display font-bold text-3xl mb-1">Amara &amp; family</h1>
        <p className="text-charcoal-teal/70 mb-6">
          This thread includes Amara and is fully visible to her parent, always.
        </p>
